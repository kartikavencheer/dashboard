  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div className="relative bg-black">
          ...
          <video
            ...
            onError={() => {
              ...
              const msg =
                code === 2
                  ? "Network error loading this video URL (often expired or blocked)."
                  : code === 3
                    ? "This video can’t be decoded by the browser (codec issue)."
                    : code === 4
                      ? "This video format/codec isn’t supported by this browser."
        ...
        {error && (
          <div className="border-t border-white/10 bg-slate-950/30 px-4 py-3 text-xs text-rose-100/90">
            {error}
          </div>
        )}
